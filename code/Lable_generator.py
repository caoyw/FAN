...
with open(r'../processed/L_15data.csv', 'w', newline='') as Ldata:
    writer = csv.writer(Ldata)
    with open(r'../15/15_data.csv', 'r+') as data:
        reader = csv.reader(data)
        next(reader)                # skip the first line
        with open(r'../15/15_failureInfo.csv', 'r+') as failureInfo:
            ...
            with open(r'../15/15_normalInfo.csv', 'r+') as normalInfo:
