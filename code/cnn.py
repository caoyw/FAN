...
if __name__=='__main__':
    ...
    model = Sequential()
    # 偏航参数
    model.add(Conv1D(64, 1, activation='relu', input_shape=(1, X_train.shape[2])))
    ...
    metrics = Metrics()
    model.fit(X_train, y_train, epochs=10, batch_size=16, validation_data=(X_test, y_test), callbacks=[metrics])
    model.summary()
